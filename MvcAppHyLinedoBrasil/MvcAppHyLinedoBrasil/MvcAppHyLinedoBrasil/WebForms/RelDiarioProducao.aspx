<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelDiarioProducao.aspx.cs"
    Inherits="MvcAppHyLinedoBrasil.WebForms.RelDiarioProducao" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Relatório Diário Completo</title>
                ...
                <table style="width: 1002px; height: 66px;">
                    <tr>
                        <td rowspan="2">
                            ...
                            <asp:HyperLink ID="hlRelatoriosFLIP" runat="server" 
                                NavigateUrl="~/WebForms/RelatoriosFLIP.aspx" Visible="False">Voltar para Relatórios FLIP</asp:HyperLink>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td class="style14">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="False"
                                Text="RELATÓRIO DIÁRIO COMPLETO"></asp:Label>
                        </td>
                    </tr>
                </table>
                <asp:Panel ID="Panel1" runat="server" Width="1003px" HorizontalAlign="Center">
                    <table align="center" style="height: 0px; width: 994px;">
                        ...
                        <tr>
                            <td style="border:1px solid #ddd;">
                                <asp:Label ID="lblGranja0" runat="server" CssClass="style27" 
                                    Text="Geração / Operação das Granjas:"></asp:Label>
                            </td>
                            <td colspan="2" style="border:1px solid #ddd;">
                                <asp:DropDownList ID="ddlGranja" runat="server" CssClass="style26" 
                                    Height="20px" Width="179px" AutoPostBack="True" 
                                    onselectedindexchanged="ddlGranja_SelectedIndexChanged">
                                    <asp:ListItem Value="PP">Produção - Brasil</asp:ListItem>
                                    <asp:ListItem Value="GP">Avós - Brasil</asp:ListItem>
                                    <asp:ListItem Value="PG">Recria - Produção - Brasil</asp:ListItem>
                                    <asp:ListItem Value="GG">Recria - Avós - Brasil</asp:ListItem>
                                    <asp:ListItem Value="MX">Mexico</asp:ListItem>
                                    <asp:ListItem Value="CL">Chile</asp:ListItem>
                                    <asp:ListItem Value="HC">Colombia / Ecuador</asp:ListItem>
                                </asp:DropDownList>
                                <br />
                            </td>
                        ...
                        <tr style="border:1px solid #ddd;">
                            <td style="border:1px solid #ddd;">
                                <asp:Label ID="lblFazenda" runat="server" CssClass="style27" Text="Fazenda:"></asp:Label>
                            </td>
...
and EF.USERTipoUnidadeFLIP = 'Granja'
Union
select E1.USERFLIPCodigo Codigo, E.EntNomeFant Nome from ENTIDADE E With(Nolock)
inner join ENTIDADE1 E1 With(Nolock) on 
	E.EntCod = E1.EntCod and E1.USERFLIPCodigo is not null and E1.USERFLIPCodigo &lt;&gt; ''
and 0 &lt; (select COUNT(1) from ENT_CATEG EC With(Nolock)
			where E.EntCod = EC.EntCod and EC.CategCodEstr = '07.01'
			and 0 &lt; (select COUNT(1) from CATEG_USUARIO C With(Nolock)
						where EC.CategCodEstr = C.CategCodEstr
						and C.UsuCod = @Login))
Order by 1">
                                        <SelectParameters>
                                    ...
                                    <asp:SqlDataSource ID="LXFARMS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:LXFLOCKS %>" 
                                        ProviderName="<%$ ConnectionStrings:LXFLOCKS.ProviderName %>" 
                                        SelectCommand="SELECT * FROM [FARMS]"></asp:SqlDataSource>
                                    <asp:SqlDataSource ID="CLFARMS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:CLFLOCKS %>" 
                                        ProviderName="<%$ ConnectionStrings:CLFLOCKS.ProviderName %>" 
                                        SelectCommand="SELECT * FROM &quot;FARMS&quot;"></asp:SqlDataSource>
                                    <asp:SqlDataSource ID="HCFARMS" runat="server" 
                                        ConnectionString="<%$ ConnectionStrings:HCFLOCKS %>" 
                                        ProviderName="<%$ ConnectionStrings:HCFLOCKS.ProviderName %>" 
                                        SelectCommand="SELECT * FROM &quot;FARMS&quot;"></asp:SqlDataSource>
                                </asp:Panel>
                            </td>
                        </tr>
                        <tr>
                            <td style="border:1px solid #ddd;">
                                <asp:Label ID="lblDataInicial" runat="server" Text="Data de Produção Inicial:" CssClass="style27"></asp:Label>
                            </td>
                            <td style="border:1px solid #ddd;">
                            ...
                            <td style="border:1px solid #ddd;">
                                <asp:Label ID="lblDataFinal0" runat="server" CssClass="style27" Text="Data de Produção Final:"></asp:Label>
                            </td>
                            <td style="border:1px solid #ddd;">
                            ...
                            <td style="border:1px solid #ddd;">
                                ...
                                <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                                    <ProgressTemplate>
                                        <br />
                                        <asp:Label ID="lblAguarde" runat="server" Text="..." Style="font-weight: 700"></asp:Label>
                                        <br />
