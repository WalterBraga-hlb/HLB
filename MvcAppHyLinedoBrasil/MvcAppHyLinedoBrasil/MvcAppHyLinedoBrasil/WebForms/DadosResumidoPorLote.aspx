<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DadosResumidoPorLote.aspx.cs" Inherits="MvcAppHyLinedoBrasil.WebForms.DadosResumidoPorLote" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Dados Resumidos do Lote</title>
            ...
            <div style="text-align: center;" class="panel">
                    ...
                    <tr>
                        ...
                        <td class="style14">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="False"
                                Text="Dados Resumidos Por Lote"></asp:Label>
                        </td>
                    </tr>
                </table>
                <asp:Panel ID="Panel1" runat="server" Width="1003px" HorizontalAlign="Center">
                    <table align="center" style="height: 0px; width: 994px;">
                        ...
                        <tr>
                            <td class="style34">
                                <asp:Label ID="lblFazenda" runat="server" Text="Fazenda:" CssClass="style27"></asp:Label>
                            </td>
                            <td class="style29">
                                <asp:DropDownList ID="ddlFazenda" runat="server" CssClass="style26" Height="20px"
                                    Width="140px">
                                    <asp:ListItem Value="HL">Hy-Line - Matriz</asp:ListItem>
                                    <asp:ListItem Value="CG">Comendador Gomes</asp:ListItem>
                                    <asp:ListItem Value="KN">Kunitomo</asp:ListItem>
                                    <asp:ListItem Value="SB">Hy-Line - Avós</asp:ListItem>
                                    <asp:ListItem Value="SM">Samambaia</asp:ListItem>
                                    <asp:ListItem>(Todas)</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td class="style33" style="text-align: right">
                                <asp:Label ID="lblGranja0" runat="server" CssClass="style27" Text="Granja:"></asp:Label>
                            </td>
                            <td>
                                <asp:DropDownList ID="ddlGranja" runat="server" CssClass="style26" Height="20px"
                                    Width="108px">
                                    <asp:ListItem Value="PP">Produção</asp:ListItem>
