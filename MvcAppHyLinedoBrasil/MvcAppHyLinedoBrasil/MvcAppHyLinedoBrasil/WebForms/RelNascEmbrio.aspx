<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelNascEmbrio.aspx.cs" Inherits="MvcAppHyLinedoBrasil.WebForms.RelNascEmbrio" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Relatório de Nascimento / Embriodiagnóstico</title>
            ...
            <div style="text-align: center;" class="panel">
                    ...
                    <tr>
                        ...
                        <td class="style14">
                            <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Size="XX-Large" Font-Underline="False"
                                Text="RELATÓRIO DE NASCIMENTO / EMBRIODIAGNÓSTICO"></asp:Label>
                        </td>
                    </tr>
                </table>
                <asp:Panel ID="Panel1" runat="server" Width="1003px" HorizontalAlign="Center">
                    <table align="center" style="height: 0px; width: 994px;">
                        ...
                        <tr>
                            <td class="style34">
                                <asp:Label ID="lblDataInicial" runat="server" Text="Data do Nascimento Inicial:" CssClass="style27"></asp:Label>
                            </td>
                            <td class="style29">
                            ...
                            <td class="style33">
                                <asp:Label ID="lblDataFinal0" runat="server" CssClass="style27" Text="Data do Nascimento Final:"></asp:Label>
                            </td>
                            <td>
