    ...
    public partial class PED_COMP: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string PedCompTranspCod
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("PedCompTranspCod", _pedCompTranspCod);
                    if (!IsDeserializing)
                    {
        ...
        public string PedCompEntCodContato
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("PedCompEntCodContato", _pedCompEntCodContato);
                    if (!IsDeserializing)
                    {
        ...
        public string PedCompEntCodLocEnt
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("PedCompEntCodLocEnt", _pedCompEntCodLocEnt);
                    if (!IsDeserializing)
                    {
        ...
        private void FixupENTIDADE(ENTIDADE previousValue, bool skipKeys = false)
        {
            ...
            if (ENTIDADE != null)
            {
                if (!ENTIDADE.PED_COMP.Contains(this))
                {
                    ENTIDADE.PED_COMP.Add(this);
                }
    
                PedCompEntCodLocEnt = ENTIDADE.EntCod;
            }
            else if (!skipKeys)
            {
                PedCompEntCodLocEnt = null;
            }
        ...
        private void FixupENTIDADE1(ENTIDADE previousValue, bool skipKeys = false)
        {
            ...
            if (ENTIDADE1 != null)
            {
                if (!ENTIDADE1.PED_COMP1.Contains(this))
                {
                    ENTIDADE1.PED_COMP1.Add(this);
                }
    
                PedCompEntCodContato = ENTIDADE1.EntCod;
            }
            else if (!skipKeys)
            {
                PedCompEntCodContato = null;
            }
        ...
        private void FixupENTIDADE2(ENTIDADE previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.PED_COMP2.Contains(this))
            {
                previousValue.PED_COMP2.Remove(this);
            }
    
            if (ENTIDADE2 != null)
            {
                if (!ENTIDADE2.PED_COMP2.Contains(this))
                {
                    ENTIDADE2.PED_COMP2.Add(this);
                }
    
                PedCompTranspCod = ENTIDADE2.EntCod;
            }
            else if (!skipKeys)
            {
                PedCompTranspCod = null;
            }
        ...
        private void FixupENTIDADE3(ENTIDADE previousValue)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (previousValue != null && previousValue.PED_COMP3.Contains(this))
            {
                previousValue.PED_COMP3.Remove(this);
            }
    
            if (ENTIDADE3 != null)
            {
                if (!ENTIDADE3.PED_COMP3.Contains(this))
                {
                    ENTIDADE3.PED_COMP3.Add(this);
                }
    
                EntCod = ENTIDADE3.EntCod;
            }
            if (ChangeTracker.ChangeTrackingEnabled)
            {
