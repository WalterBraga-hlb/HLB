    ...
    public partial class ENTIDADE1: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string CondPagCodPag
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("CondPagCodPag", _condPagCodPag);
                    if (!IsDeserializing)
                    {
        ...
        [DataMember]
        public TrackableCollection<ENT_FONE> ENT_FONE
        {
            get
            {
                if (_eNT_FONE == null)
                {
                    _eNT_FONE = new TrackableCollection<ENT_FONE>();
                    _eNT_FONE.CollectionChanged += FixupENT_FONE;
                }
                return _eNT_FONE;
            }
            set
            {
                if (!ReferenceEquals(_eNT_FONE, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    if (_eNT_FONE != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (ENT_FONE item in _eNT_FONE)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
                    ...
                    OnNavigationPropertyChanged("ENT_FONE");
                }
            }
        }
        private TrackableCollection<ENT_FONE> _eNT_FONE;
        ...
        [DataMember]
        public TrackableCollection<ENT_WEB> ENT_WEB
        {
            get
            {
                if (_eNT_WEB == null)
                {
                    _eNT_WEB = new TrackableCollection<ENT_WEB>();
                    _eNT_WEB.CollectionChanged += FixupENT_WEB;
                }
                return _eNT_WEB;
            }
            set
            {
                if (!ReferenceEquals(_eNT_WEB, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    if (_eNT_WEB != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (ENT_WEB item in _eNT_WEB)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
                    ...
                    OnNavigationPropertyChanged("ENT_WEB");
                }
            }
        }
        private TrackableCollection<ENT_WEB> _eNT_WEB;
        ...
        private void FixupCOND_PAG1(COND_PAG previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.ENTIDADE11.Contains(this))
            {
                previousValue.ENTIDADE11.Remove(this);
            }
    
            if (COND_PAG1 != null)
            {
                if (!COND_PAG1.ENTIDADE11.Contains(this))
                {
                    COND_PAG1.ENTIDADE11.Add(this);
                }
    
                CondPagCodPag = COND_PAG1.CondPagCod;
            }
            else if (!skipKeys)
            {
                CondPagCodPag = null;
        ...
        private void FixupENT_FONE(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ENT_FONE item in e.NewItems)
                {
                    item.ENTIDADE1 = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ENT_FONE", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
                    // Update the event listener to refer to the new dependent.
                    ChangeTracker.ObjectStateChanging += item.HandleCascadeDelete;
            ...
            if (e.OldItems != null)
            {
                foreach (ENT_FONE item in e.OldItems)
                {
                    if (ReferenceEquals(item.ENTIDADE1, this))
                    {
                        item.ENTIDADE1 = null;
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ENT_FONE", item);
                        // Delete the dependent end of this identifying association. If the current state is Added,
                        // allow the relationship to be changed without causing the dependent to be deleted.
                        if (item.ChangeTracker.State != ObjectState.Added)
                        {
        ...
        private void FixupENT_WEB(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ENT_WEB item in e.NewItems)
                {
                    item.ENTIDADE1 = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ENT_WEB", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
                    // Update the event listener to refer to the new dependent.
                    ChangeTracker.ObjectStateChanging += item.HandleCascadeDelete;
            ...
            if (e.OldItems != null)
            {
                foreach (ENT_WEB item in e.OldItems)
                {
                    if (ReferenceEquals(item.ENTIDADE1, this))
                    {
                        item.ENTIDADE1 = null;
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ENT_WEB", item);
                        // Delete the dependent end of this identifying association. If the current state is Added,
                        // allow the relationship to be changed without causing the dependent to be deleted.
                        if (item.ChangeTracker.State != ObjectState.Added)
                        {
