...
namespace MvcAppHyLinedoBrasil.Models
{
    ...
    public partial class VU_Teste_Gera_Ocor_Auto: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        #region Primitive Properties
    
        [DataMember]
        public Nullable<int> SemanaAnoServico
        {
            get { return _semanaAnoServico; }
            set
            {
                if (_semanaAnoServico != value)
                {
                    _semanaAnoServico = value;
                    OnPropertyChanged("SemanaAnoServico");
                }
            }
        }
        private Nullable<int> _semanaAnoServico;
