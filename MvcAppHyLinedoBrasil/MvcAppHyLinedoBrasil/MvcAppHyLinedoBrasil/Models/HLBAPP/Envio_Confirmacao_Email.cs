...
namespace MvcAppHyLinedoBrasil.Models.HLBAPP
{
    ...
    public partial class Envio_Confirmacao_Email: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> WorkFlowEmailSeq
        {
        ...
        private Nullable<int> _workFlowEmailSeq;
        ...
        private void FixupEnvio_Confirmacao(Envio_Confirmacao previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.Envio_Confirmacao_Email.Contains(this))
            {
                previousValue.Envio_Confirmacao_Email.Remove(this);
            }
    
            if (Envio_Confirmacao != null)
            {
                if (!Envio_Confirmacao.Envio_Confirmacao_Email.Contains(this))
                {
                    Envio_Confirmacao.Envio_Confirmacao_Email.Add(this);
                }
