...
namespace MvcAppHyLinedoBrasil.Models.DiarioProducaoRacao
{
    ...
    public partial class REQ_MAT_CLASSE_REC_DESP: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<decimal> ReqMatClasseRecDespPerc
        {
            get { return _reqMatClasseRecDespPerc; }
            set
            {
                if (_reqMatClasseRecDespPerc != value)
                {
                    _reqMatClasseRecDespPerc = value;
                    OnPropertyChanged("ReqMatClasseRecDespPerc");
                }
            }
        }
        private Nullable<decimal> _reqMatClasseRecDespPerc;
        ...
        private void FixupREQ_MAT(REQ_MAT previousValue)
        {
            ...
            if (previousValue != null && previousValue.REQ_MAT_CLASSE_REC_DESP.Contains(this))
            {
                previousValue.REQ_MAT_CLASSE_REC_DESP.Remove(this);
            }
    
            if (REQ_MAT != null)
            {
                if (!REQ_MAT.REQ_MAT_CLASSE_REC_DESP.Contains(this))
                {
                    REQ_MAT.REQ_MAT_CLASSE_REC_DESP.Add(this);
                }
