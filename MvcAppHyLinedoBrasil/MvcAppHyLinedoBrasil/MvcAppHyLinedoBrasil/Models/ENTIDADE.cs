    ...
    public partial class ENTIDADE: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string EntSegNacionPaisSigla
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("EntSegNacionPaisSigla", _entSegNacionPaisSigla);
                    if (!IsDeserializing)
                    {
                        if (PAIS != null && PAIS.PaisSigla != value)
                        {
                            PAIS = null;
                        }
                    }
        ...
        public string EquipCodEstr
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("EquipCodEstr", _equipCodEstr);
                    if (!IsDeserializing)
                    {
                        if (EQUIPAMENTO != null && EQUIPAMENTO.EquipCodEstr != value)
                        {
                            EQUIPAMENTO = null;
                        }
                    }
        ...
        [DataMember]
        public TrackableCollection<MOV_ESTQ> MOV_ESTQ4
        {
            get
            {
                if (_mOV_ESTQ4 == null)
                {
                    _mOV_ESTQ4 = new TrackableCollection<MOV_ESTQ>();
                    _mOV_ESTQ4.CollectionChanged += FixupMOV_ESTQ4;
                }
                return _mOV_ESTQ4;
            }
            set
            {
                if (!ReferenceEquals(_mOV_ESTQ4, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    OnNavigationPropertyChanged("MOV_ESTQ4");
                }
            }
        }
        private TrackableCollection<MOV_ESTQ> _mOV_ESTQ4;
        ...
        [DataMember]
        public TrackableCollection<PED_COMP> PED_COMP2
        {
            get
            {
                if (_pED_COMP2 == null)
                {
                    _pED_COMP2 = new TrackableCollection<PED_COMP>();
                    _pED_COMP2.CollectionChanged += FixupPED_COMP2;
                }
                return _pED_COMP2;
            }
            set
        ...
        private TrackableCollection<PED_COMP> _pED_COMP2;
    
        [DataMember]
        public TrackableCollection<PED_COMP> PED_COMP3
        {
            get
            {
                if (_pED_COMP3 == null)
                {
                    _pED_COMP3 = new TrackableCollection<PED_COMP>();
                    _pED_COMP3.CollectionChanged += FixupPED_COMP3;
                }
                return _pED_COMP3;
            }
            set
            {
                if (!ReferenceEquals(_pED_COMP3, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    OnNavigationPropertyChanged("PED_COMP3");
                }
            }
        }
        private TrackableCollection<PED_COMP> _pED_COMP3;
        ...
        public EQUIPAMENTO EQUIPAMENTO
        {
            ...
            set
            {
                ...
                {
                    var previousValue = _eQUIPAMENTO;
                    _eQUIPAMENTO = value;
                    FixupEQUIPAMENTO(previousValue);
        ...
        [DataMember]
        public TrackableCollection<EQUIPAMENTO> EQUIPAMENTO2
        {
            get
            {
                if (_eQUIPAMENTO2 == null)
                {
                    _eQUIPAMENTO2 = new TrackableCollection<EQUIPAMENTO>();
                    _eQUIPAMENTO2.CollectionChanged += FixupEQUIPAMENTO2;
                }
                return _eQUIPAMENTO2;
            }
            set
            {
                if (!ReferenceEquals(_eQUIPAMENTO2, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    OnNavigationPropertyChanged("EQUIPAMENTO2");
                }
            }
        }
        private TrackableCollection<EQUIPAMENTO> _eQUIPAMENTO2;
            ...
            set
            {
                if (!ReferenceEquals(_eNT_CONTATO, value))
                {
                    ...
                    if (_eNT_CONTATO != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (ENT_CONTATO item in _eNT_CONTATO)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
        ...
        private void FixupCOND_PAG(COND_PAG previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.ENTIDADE.Contains(this))
            {
                previousValue.ENTIDADE.Remove(this);
            }
    
            if (COND_PAG != null)
            {
                if (!COND_PAG.ENTIDADE.Contains(this))
                {
                    COND_PAG.ENTIDADE.Add(this);
                }
        ...
        private void FixupPAIS(PAIS previousValue, bool skipKeys = false)
        {
            ...
            if (PAIS != null)
            {
                if (!PAIS.ENTIDADE.Contains(this))
                {
                    PAIS.ENTIDADE.Add(this);
                }
    
                EntSegNacionPaisSigla = PAIS.PaisSigla;
            }
            else if (!skipKeys)
            {
                EntSegNacionPaisSigla = null;
            }
        ...
        private void FixupEQUIPAMENTO(EQUIPAMENTO previousValue, bool skipKeys = false)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (EQUIPAMENTO != null)
            {
                if (!EQUIPAMENTO.ENTIDADE.Contains(this))
                {
                    EQUIPAMENTO.ENTIDADE.Add(this);
                }
    
                EquipCodEstr = EQUIPAMENTO.EquipCodEstr;
            }
            else if (!skipKeys)
            {
                EquipCodEstr = null;
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                if (ChangeTracker.OriginalValues.ContainsKey("EQUIPAMENTO")
                    && (ChangeTracker.OriginalValues["EQUIPAMENTO"] == EQUIPAMENTO))
                {
                    ChangeTracker.OriginalValues.Remove("EQUIPAMENTO");
                }
                else
                {
                    ChangeTracker.RecordOriginalValue("EQUIPAMENTO", previousValue);
                }
                if (EQUIPAMENTO != null && !EQUIPAMENTO.ChangeTracker.ChangeTrackingEnabled)
                {
                    EQUIPAMENTO.StartTracking();
                }
            }
        }
        ...
        private void FixupMOV_ESTQ4(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (MOV_ESTQ item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("MOV_ESTQ4", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (MOV_ESTQ item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("MOV_ESTQ4", item);
                    }
                }
            }
        }
        ...
        private void FixupPED_COMP2(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (PED_COMP item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("PED_COMP2", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (PED_COMP item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("PED_COMP2", item);
                    }
                }
            }
        }
    
        private void FixupPED_COMP3(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (PED_COMP item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("PED_COMP3", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (PED_COMP item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("PED_COMP3", item);
                    }
                }
            }
        }
        ...
        private void FixupEQUIPAMENTO2(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (EQUIPAMENTO item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("EQUIPAMENTO2", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (EQUIPAMENTO item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("EQUIPAMENTO2", item);
                    }
                }
            }
        }
