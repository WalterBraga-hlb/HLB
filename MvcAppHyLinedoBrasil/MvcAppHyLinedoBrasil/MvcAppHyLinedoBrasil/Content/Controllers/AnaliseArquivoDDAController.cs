...
namespace MvcAppHyLinedoBrasil.Controllers
{
    public class AnaliseArquivoDDAController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            bd.Database.ExecuteSqlCommand("delete from LayoutDDASegmentoGs");
            bd.SaveChanges();
            return View(bd.LinhasSegmentoG);
        }
        ...
        public ActionResult AnaliseArquivo()
        {
            ...
            try
            {
                bd.Database.ExecuteSqlCommand("delete from LayoutDDASegmentoGs where UserSession = '" +
                ...
                foreach (var item in lista)
                {
                    ...
                    if (ef != null)
                    {
                        ...
                        if (parcela != null)
                        {
                            ...
                            PARC_DOC_FIN parcelaComEntidade = bdFinanceiro.PARC_DOC_FIN
                        ...
                        if (int.TryParse(fileIdsEmailFiscal[index], out fileId))
                        {
                            foreach (LayoutDDASegmentoG item in bd.LinhasSegmentoG.ToList())
                            {
                                if (fileId == item.ID)
                                {
                                    ...
                                    email.WorkFlowEmailParaEmail = "nfe@hyline.com.br";
