...
using MvcAppHyLinedoBrasil.WebForms;
...
namespace MvcAppHyLinedoBrasil.Controllers
{
    public class ImportaPedidosCHICController : Controller
    {
        ...
        Data.CHICDataSet chic = new Data.CHICDataSet();
        ...
        public ActionResult ImportaDadosPlanilhaPedido()
        {
            ...
            //caminho = @"\\srv-riosoft-01\W\Relatorios_CHIC\Pedidos_Importados\" + DateTime.Now.ToLongTimeString().Replace(":", "-") + "_" + Request.Files[0].FileName;
            ...
            caminho = @"\\srv-riosoft-01\W\Relatorios_CHIC\Pedidos_Importados\" + 
                ...
                foreach (var planilha in lista)
                {
                    ...
                    {   
                        ...
                        ****/
                        ...
                        {
                            MvcAppHyLinedoBrasil.Models.ENTIDADE1 entidade1 = apolo2.ENTIDADE1
            ...
            try
            {
                ...
                foreach (var item in lista)
                {
                    ...
                    else if (item.Operacao.Equals("Alterar"))
                    {
                        ...
                        order.UpdateQuery(orderDate, custoNo, item.DataInicial, 
                        ...
                        if (item.QtdeReposicao > 0)
                        {
                            ...
                            Data.CHICDataSet.int_commDataTable intCommReposicaoDT = new Data.CHICDataSet.int_commDataTable();
                ...
                Models.Apolo.WORKFLOW_EMAIL email = new Models.Apolo.WORKFLOW_EMAIL();
        ...
        public void CarregaListaTipoAtualizacaoSistemas()
        {
            List<SelectListItem> listaTipoAtualizacaoSistemas = new List<SelectListItem>();

            listaTipoAtualizacaoSistemas
                .Add(new SelectListItem { Text = "(Todos)", Value = "(Todos)", Selected = false });
            listaTipoAtualizacaoSistemas
                .Add(new SelectListItem { Text = "Somente 01 Pedido", Value = "Somente 01 Pedido", Selected = true });

            Session["ListaTipoAtualizacaoSistemas"] = listaTipoAtualizacaoSistemas;
        }
        ...
        public string GeraRelConfirmacao(string orderNo, string cliente, string empresa)
        {
            ...
            //string caminho = @"\\srv-riosoft-01\W\Conf\" + cliente.Replace("\\","").Replace("/","") + "_" + orderNo + ".pdf";
            //string caminho = @"\\srv-riosoft-01\W\Conf\Pedido_" + orderNo + ".pdf";
            string caminho = @"\\srv-riosoft-01\W\Conf\" + nameFileNew2 + "_" + orderNo + ".pdf";
        ...
        public static string GeraRelNovaConfirmacao(string idPV, string cliente, string operacao, string nomeRelatorio)
        {
            string pattern = @"(?i)[^0-9a-z\s]";
            string replacement = "";
            Regex rgx = new Regex(pattern);
            ...
            string caminho = @"\\srv-riosoft-01\W\Conf\" + nameFileNew2 + "_" + idPV + "_" + operacao +".pdf";

            CrystalDecisions.CrystalReports.Engine.ReportDocument MyReport = new CrystalDecisions.CrystalReports.Engine.ReportDocument();
            MyReport.Load("\\\\srv-web-02\\c$\\inetpub\\wwwroot\\Relatorios\\Crystal\\" + nomeRelatorio + ".rpt");
            MyReport.SetParameterValue("@pIDPedidoVenda", idPV);
        ...
        public static string EnviaConfirmacaoEmail(string caminho, string enderecoEmail, string representante, string orderno, 
            string cliente, string copiaPara, string corpo, string assunto)
        {
            try
            {
                ...
                ApoloEntities apoloSession = new ApoloEntities();
                ...
                email.WorkFlowEmailArquivosAnexos = caminho;
                email.WorkFlowEmailDocEspec = "CONF";
                email.WorkFlowEmailDocSerie = "New";
                email.WorkFlowEmailDocNum = orderno;
        ...
        public ActionResult EnviaConfirmacoes(FormCollection model)
        {
            ...
            try
            {
                    ...
                    foreach (var index in selectedIndices)
                    {
                        ...
                        if (int.TryParse(fileIds[index], out fileId))
                        {
                            ...
                            if (tipoAgrupamentoPedidos.Equals("Pedido"))
                            {
                                ...
                                #region Erro ao enviar o e-mail

                                //if (erro != "")
                                int emailSeq = 0;
                                if (!int.TryParse(erro, out emailSeq))
                                { 
                                    string opcaoData = "Nascimento";
                                    ...
                                    msg = "Erro ao enviar e-mail por pedido: " + erro;
                                    ViewBag.erro = msg;
                            ...
                            else if (tipoAgrupamentoPedidos.Equals("Vendedor"))
                            {
                                ...
                                {
                                Data.CHICDataSet.salesmanDataTable vendedorAnteriorDT = new Data.CHICDataSet.salesmanDataTable();
                                    ...
                                    if (!int.TryParse(erro, out emailSeq))
                                    {
                                        ...
                                        msg = "Erro ao enviar e-mail por vendedor: " + erro;
                                        ViewBag.erro = msg;
                            ...
                            else if (tipoAgrupamentoPedidos.Equals("Empresa"))
                            {
                                ...
                                else
                                {
                                    ...
                                    if (!int.TryParse(erro, out emailSeq))
                                    {
                                        ...
                                        msg = "Erro ao enviar e-mail por empresa: " + erro;
                                        ViewBag.erro = msg;
                ...
                ordersConf.FillByConf(chic.ordersConf, opcaoData1, dataInicialHoje, dataFinalHoje
                    , opcaoData1, dataInicialHoje, dataFinalHoje, opcaoData1, dataInicialHoje,
                dataFinalHoje, cliente1, cliente1, vendedor1, vendedor1, empresa1, empresa1, false);
            ...
            catch (Exception e)
            {
                ...
                if (e.InnerException == null)
                    msg = "Erro ao enviar confirmações: " + e.Message;
                else
                    msg = "Erro ao enviar confirmações: " + e.Message + " / " + e.InnerException.Message;
        ...
        public ActionResult EnviarConfirmacoesFaturamento(FormCollection model)
        {
            ...
            if (empresaDireitos.Contains("BR") && empresa.Equals("BR"))
            {
            ...
            else if (empresaDireitos.Contains("LB") && empresa.Equals("LB"))
            {
                if (copiaParaFaturamento == "")
            ...
            else if (empresaDireitos.Contains("HN") && empresa.Equals("HN"))
            {
                if (copiaParaFaturamento == "")
            ...
            else if (empresaDireitos.Contains("PL") && empresa.Equals("PL"))
            {
                if (copiaParaFaturamento == "")
        ...
        #region Atualização CHIC para Embarcador / Apolo

        public string AtualizaPedidoCHICEmbarcador(string ordernoCHIC)
        {
            string erroRetorno = "";

            ImportaCHIC servico = new ImportaCHIC();
            erroRetorno = servico.ImportaPedidoEmbarcador(ordernoCHIC, "Manual");
            
            return erroRetorno;
        }

        public string AtualizaPedidoCHICApolo(string ordernoCHIC)
        {
            //ImportaCHICService.ImportaCHIC.ImportaPedidosCHICStatic(ordernoCHIC);
            
            string erroRetorno = "";

            #region Verifica se existe dados de transporte. Caso não tenha, avisar o usuário

            HLBAPPServiceEntities hlbappSession = new HLBAPPServiceEntities();

            var dadosTransporte = hlbappSession.Prog_Diaria_Transp_Pedidos
                .Where(w => (w.CHICNum == ordernoCHIC || w.CHICNumReposicao == ordernoCHIC)
            ...
            {
                return erroRetorno = "Pedido " + ordernoCHIC + " sem dados de transporte (o status tem que ser 'Conferido')! Verifique e realize a inclusão dos dados!";
            }

            #endregion

            #region Verifica se já existe NF com esse pedido. Caso tenha, avisar o usuário

            ApoloEntities apoloSession = new ApoloEntities();

            var pv1 = apoloSession.PED_VENDA1
                .Where(w => w.USERPEDCHIC == ordernoCHIC)
                .FirstOrDefault();

            if (pv1 != null)
            {
                var existeNF = apoloSession.NOTA_FISCAL
                    .Where(w => w.EmpCod == pv1.EmpCod && w.NFPedVenda == pv1.PedVendaNum)
                    .FirstOrDefault();

                if (existeNF != null)
                {
                    return erroRetorno = "Pedido " + ordernoCHIC + " já faturado na NF " + existeNF.EmpCod + " - " + existeNF.NFNum + "!";
                }
            }
            ...
            if (ordernoCHIC != "")
                erroRetorno = servico.ImportaPedidosCHIC(ordernoCHIC);
            else
        ...
        public ActionResult AtualizaPedidoSistemasIndex()
        {
            CarregaListaTipoAtualizacaoSistemas();
            Session["mesAtualizacao"] = DateTime.Today.ToString("yyyy-MM");
            //EnviaConfirmacoesAniPlan();
            return View("AtualizaPedidoSistemas");
        }

        public ActionResult AtualizaPedidoSistemas(FormCollection model)
        {
            if (VerificaSessao()) return RedirectToAction("LogOn", "Account");
            string erroRetorno = "";
            ...
            try
            {
                ...
                string atualizaApolo = "";
                string atualizaEmbarcador = "";
                string ordernoCHIC = "";
                ...
                if (model["TipoAtualizacaoSistemas"] != null)
                    tipoAtualizacao = model["TipoAtualizacaoSistemas"].ToString();

                if (model["ordernoCHIC"] != null)
                    ordernoCHIC = model["ordernoCHIC"].ToString();
                else
                {
                    ViewBag.erro = "Por favor, informar um número do pedido no CHIC!";
                    return View("AtualizaPedidoSistemas");
                }
                
                if (tipoAtualizacao == "Somente 01 Pedido" && ordernoCHIC == "")
                {
                    ViewBag.erro = "Por favor, informar um número do pedido no CHIC!";
                    return View("AtualizaPedidoSistemas");
                }

                if ((model["atualizaApolo"] != null) || (model["atualizaEmbarcador"] != null))
                {
                    atualizaApolo = model["atualizaApolo"].Replace("true,false", "true");
                    atualizaEmbarcador = model["atualizaEmbarcador"].Replace("true,false", "true");

                    if (atualizaApolo.Equals("false") && atualizaEmbarcador.Equals("false"))
                    {
                        ViewBag.erro = "Por favor, selecione pelo menos uma opção para o atualização!";
                        return View("AtualizaPedidoSistemas");
                    }
                }
                else
                ...
                #region Verifica se existe pedido no CHIC

                Data.CHICDataSet.ordersDataTable oDT = new Data.CHICDataSet.ordersDataTable();
                order.FillByOrderNo(oDT, ordernoCHIC);
                if (oDT.Count == 0)
                {
                    ViewBag.erro = "Pedido " + ordernoCHIC + "  não existe no CHIC! Verifique!";
                    return View("AtualizaPedidoSistemas");
                }
                ...
                #region Atualiza Embarcador

                if (atualizaEmbarcador.Equals("true")  && ordernoCHIC != "")
                {
                    erroRetorno = AtualizaPedidoCHICEmbarcador(ordernoCHIC);
                    if (erroRetorno != "")
                    {
                        ViewBag.erro = erroRetorno;
                        return View("AtualizaPedidoSistemas");
                    }
                }
                ...
                if (atualizaApolo.Equals("true") || tipoAtualizacao == "(Todos)")
                {
                    erroRetorno = "";
                    erroRetorno = AtualizaPedidoCHICApolo(ordernoCHIC);
                    if (erroRetorno != "")
                    {
                        ViewBag.erro = erroRetorno;
                        return View("AtualizaPedidoSistemas");
                ...
                ViewBag.fileName = "Pedidos " + ordernoCHIC + " importado com sucesso!";
            ...
            catch (Exception ex)
            {
                ...
                erroRetorno = "Erro ao Atualizar CHIC com Embarcador / Apolo - Erro Linha: " + linenum.ToString()
        ...
        #region Atualização CHIC p/ Web Mensal

        public ActionResult AtualizaCHICxWebMensal(FormCollection model)
        {
            if (VerificaSessao()) return RedirectToAction("LogOn", "Account");
            string erroRetorno = "";
            HLBAPPServiceEntities hlbappSession = new HLBAPPServiceEntities();
            ...
            string mesAtualizacao = "";
            if (model["mesAtualizacao"] != null)
            {
                mesAtualizacao = model["mesAtualizacao"].ToString();
                Session["mesAtualizacao"] = mesAtualizacao;
            }

            #endregion

            #region Verifica se existe atualização sendo realizada

            var atualizacaoEmAndamento = hlbappSession.LOG_Atualizacao_CHIC_SQLServer.Where(w => w.DataHoraFim == null).FirstOrDefault();
            if (atualizacaoEmAndamento != null)
            {
                ViewBag.erro = "A atualização já está sendo executada pelo usuário " + atualizacaoEmAndamento.Usuario
                    + "! Por favor, aguarde!";
            ...
            #region Insere LOG Atualização

            LOG_Atualizacao_CHIC_SQLServer log = new LOG_Atualizacao_CHIC_SQLServer();
            log.DataHoraInicio = DateTime.Now;
            log.Usuario = Session["usuario"].ToString();
            log.Periodo = mesAtualizacao;
            hlbappSession.LOG_Atualizacao_CHIC_SQLServer.AddObject(log);
            ...
            try
            {
                int ano = Convert.ToInt32(mesAtualizacao.Substring(0, 4));
                int mes = Convert.ToInt32(mesAtualizacao.Substring(5, 2));
                DateTime dataInicial = new DateTime(ano, mes, 1);
                DateTime dataFinal = new DateTime(ano, mes, DateTime.DaysInMonth(ano, mes));

                while (dataInicial <= dataFinal)
                {
                    ProgDiarioTransp pdt = new ProgDiarioTransp();
                    pdt.AtualizaPedidosCHICProgDiariaTransp(dataInicial, "", "UPD");

                    dataInicial = dataInicial.AddDays(1);
                }

                log.DataHoraFim = DateTime.Now;
                log.Observacao = "Atualização realizada com sucesso!";
                hlbappSession.SaveChanges();

                ViewBag.fileName = "Atualização realizada com sucesso!";
            ...
            {
                int linenum = Convert.ToInt32(ex.StackTrace.Substring(ex.StackTrace.LastIndexOf(' ')));
                erroRetorno = "Erro ao Atualizar CHIC com Web Manualmente - Erro Linha: " + linenum.ToString()
                    + " / Erro primário: " + ex.Message;
                if (ex.InnerException != null)
                    erroRetorno = erroRetorno + " Erro Secundário: " + ex.InnerException.Message;
        ...
        #region Envio Novas Confirmações - AniPlan

        public static void EnviaConfirmacoesAniPlan()
        {
            int idECErro = 0;

            Models.HLBAPP.HLBAPPEntities1 hlbappSession = new Models.HLBAPP.HLBAPPEntities1();
            ImportaCHICService.Data.HLBAPPServiceEntities hlbappService = new HLBAPPServiceEntities();
            ApoloEntities apoloSession = new ApoloEntities();

            try
            {
                #region Carrega Confirmacoes Pendentes para Envio

                var listaEC = hlbappSession.Envio_Confirmacao
                ...
                foreach (var ec in listaEC)
                {
                    #region Carrega Dados do Envio

                    idECErro = ec.ID;

                    System.Globalization.CultureInfo calendarioLocal = new CultureInfo("PT-BR");
                    int semanaDoAnoInicial = calendarioLocal.Calendar.GetWeekOfYear(Convert.ToDateTime(ec.DataInicial),
                        System.Globalization.CalendarWeekRule.FirstFourDayWeek,
                        System.DayOfWeek.Sunday);
                    int semanaDoAnoFinal = calendarioLocal.Calendar.GetWeekOfYear(Convert.ToDateTime(ec.DataFinal),
                        System.Globalization.CalendarWeekRule.FirstFourDayWeek,
                        System.DayOfWeek.Sunday);

                    DateTime dataInicial = Convert.ToDateTime(ec.DataInicial);
                    DateTime dataFinal = Convert.ToDateTime(ec.DataFinal);

                    string tipoAgrupamentoPedidos = ec.TipoAgrupamento;
                    string enviarEmailEmpresa = (ec.EnviarEmpresa == 1 ? "true" : "false");
                    string enviarEmailVendedor = (ec.EnviarVendedor == 1 ? "true" : "false");

                    var listaItensEC = hlbappSession.Envio_Confirmacao_PV
                        .Where(w => w.IDEnvioConfirmacao == ec.ID)
                        .ToList();

                    ec.DataHoraInicio = DateTime.Now;

                    #endregion

                    string anexos = "";

                    if (tipoAgrupamentoPedidos.Equals("Empresa"))
                    {
                        #region Envio por Empresa

                        var listaEmpresas = listaItensEC
                            .GroupBy(g => g.Empresa)
                            .ToList();
                        ...
                        foreach (var empresa in listaEmpresas)
                        {
                            ...
                            string emailGrupoEmpresa = "";
                            if (empresa.Key.Equals("BR") && enviarEmailEmpresa.Equals("true"))
                            {
                                emailGrupoEmpresa = "confirmacoes@hyline.com.br";
                                emailRetorno = "programacao@hyline.com.br";
                            }
                            else if (empresa.Key.Equals("LB") && enviarEmailEmpresa.Equals("true"))
                            {
                                emailGrupoEmpresa = "confirmacoes@ltz.com.br";
                                emailRetorno = "programacao@ltz.com.br";
                            }
                            else if (empresa.Key.Equals("HN") && enviarEmailEmpresa.Equals("true"))
                            {
                                emailGrupoEmpresa = "confirmacoes@hnavicultura.com.br";
                                emailRetorno = "programacao@hnavicultura.com.br";
                            }
                            else if (empresa.Key.Equals("PL") && enviarEmailEmpresa.Equals("true"))
                            {
                                emailGrupoEmpresa = "programacao@planaltopostura.com.br";
                                emailRetorno = "programacao@planaltopostura.com.br";
                            }

                            var listaItensEmpresa = listaItensEC
                                .Where(w => w.Empresa == empresa.Key)
                                .OrderBy(o => o.Vendedor)
                                .ToList();

                            #endregion

                            foreach (var item in listaItensEmpresa)
                            {
                                #region Carrega Dados do Pedido

                                Pedido_Venda pv = hlbappService.Pedido_Venda.Where(w => w.ID == item.IDPedidoVenda).FirstOrDefault();
                                //var codVendedorApolo = "0" + pv.Vendedor;
                                Models.Apolo.VENDEDOR v = apoloSession.VENDEDOR.Where(w => w.VendCod == item.Vendedor).FirstOrDefault();
                                string idPV = item.IDPedidoVenda.ToString();

                                item.DataHoraInicio = DateTime.Now;

                                #endregion

                                string caminho = GeraRelNovaConfirmacao(idPV, pv.NomeCliente, item.TipoPedido, "NovaConfirmacao");
                                if (anexos == "")
                                    anexos = caminho;
                                else
                                    anexos = anexos + "^" + caminho;
                            ...
                            assuntoEmail = "CONFIRMAÇÕES DE " + dataInicial.ToShortDateString() + " a " + dataFinal.ToShortDateString();

                            corpoEmail = "Prezados," + (char)13 + (char)10 + (char)13 + (char)10
                                + "Segue em anexo as confirmações dos lotes programados no período das semanas de "
                                + semanaDoAnoInicial.ToString() + " a " + semanaDoAnoFinal.ToString() + "/"
                                + dataInicial.ToString("yyyy") + " ("
                                + dataInicial.ToShortDateString() + " a "
                                + dataFinal.ToShortDateString()
                                + ") conforme as disponibilidades de produto,espaço de incubação e rota."
                                + (char)13 + (char)10
                            ...
                            erro = EnviaConfirmacaoEmail(anexos, emailGrupoEmpresa, emailGrupoEmpresa,
                                    ec.ID.ToString(), "", emailRetorno, corpoEmail, assuntoEmail);

                            #region Erro ao enviar o e-mail

                            Models.HLBAPP.Envio_Confirmacao_Email envio = new Models.HLBAPP.Envio_Confirmacao_Email();
                            envio.IDEnvioConfirmacao = ec.ID;
                            envio.TipoEnvio = tipoAgrupamentoPedidos;

                            int emailSeq = 0;
                            if (!int.TryParse(erro, out emailSeq))
                            {
                                string msg = "Erro ao enviar e-mail por empresa: " + erro;
                            ...
                            else
                            {
                                ...
                                envio.WorkFlowEmailSeq = emailSeq;
                            }

                            hlbappSession.Envio_Confirmacao_Email.AddObject(envio);
                    ...
                    {
                        #region Envio por Vendedor

                        var listaVendedores = listaItensEC
                            .GroupBy(g => g.Vendedor)
                            .ToList();

                        foreach (var vendedor in listaVendedores)
                        {
                            #region Carrega Dados do Vendedor
                            ...
                            var listaItensVendedor = listaItensEC
                                .Where(w => w.Vendedor == vendedor.Key)
                                .OrderBy(o => o.Vendedor)
                                .ToList();

                            #endregion

                            foreach (var item in listaItensVendedor)
                            {
                                #region Carrega Dados da Empresa

                                if (item.Empresa.Equals("BR") && enviarEmailEmpresa.Equals("true"))
                                {
                                    emailGrupoEmpresa = "confirmacoes@hyline.com.br";
                                    emailRetorno = "programacao@hyline.com.br";
                                }
                                else if (item.Empresa.Equals("LB") && enviarEmailEmpresa.Equals("true"))
                                {
                                    emailGrupoEmpresa = "confirmacoes@ltz.com.br";
                                    emailRetorno = "programacao@ltz.com.br";
                                }
                                else if (item.Empresa.Equals("HN") && enviarEmailEmpresa.Equals("true"))
                                {
                                    emailGrupoEmpresa = "confirmacoes@hnavicultura.com.br";
                                    emailRetorno = "programacao@hnavicultura.com.br";
                                }
                                else if (item.Empresa.Equals("PL") && enviarEmailEmpresa.Equals("true"))
                                {
                                    emailGrupoEmpresa = "programacao@planaltopostura.com.br";
                                    emailRetorno = "programacao@planaltopostura.com.br";
                                }
                            ...
                            Models.Apolo.VENDEDOR vAnterior = apoloSession.VENDEDOR.Where(w => w.VendCod == vendedor.Key).FirstOrDefault();

                            assuntoEmail = "CONFIRMAÇÕES DE " + dataInicial.ToShortDateString() + " a " + dataFinal.ToShortDateString();

                            corpoEmail = "Prezado " + vAnterior.VendNome + "," + (char)13 + (char)10 + (char)13 + (char)10
                                + "Segue em anexo as confirmações dos lotes programados no período das semanas de "
                                + semanaDoAnoInicial.ToString() + " a " + semanaDoAnoFinal.ToString() + "/"
                                + dataInicial.ToString("yyyy") + " ("
                                + dataInicial.ToShortDateString() + " a "
                            ...
                            if (enviarEmailVendedor == "true")
                                erro = EnviaConfirmacaoEmail(anexos, vAnterior.USERLoginSite, vAnterior.VendNome,
                                    ec.ID.ToString(), "", emailGrupoEmpresa + ";" + emailRetorno,
                                    corpoEmail, assuntoEmail);
                            else
                                erro = EnviaConfirmacaoEmail(anexos, emailGrupoEmpresa, emailGrupoEmpresa,
                                    ec.ID.ToString(), "", emailRetorno, corpoEmail, assuntoEmail);
                            ...
                            if (!int.TryParse(erro, out emailSeq))
                            {
                                string msg = "Erro ao enviar e-mail por vendedor: " + erro;
                    ...
                    else if (tipoAgrupamentoPedidos.Equals("Pedido"))
                    {
                        #region Envio por Pedido
                        ...
                        foreach (var item in listaItensEC)
                        {
                            #region Carrega Dados da Empresa
                            ...
                            assuntoEmail = "CONFIRMAÇÃO DO PEDIDO " + idPV + " - " + pv.NomeCliente;

                            corpoEmail = "Prezado " + v.VendNome + "," + (char)13 + (char)10 + (char)13 + (char)10
                                + "Segue em anexo a Confirmação do pedido " + idPV + " do cliente " + pv.NomeCliente + "." + (char)13 + (char)10
                                + "Por favor, retornar assinado para concluir a venda!" + (char)13 + (char)10 + (char)13 + (char)10
                                + "Qualquer dúvida, entrar em contato pelo e-mail " + emailRetorno + "." + (char)13 + (char)10 + (char)13 + (char)10
                                + "SISTEMA WEB";

                            if (enviarEmailVendedor == "true")
                                erro = EnviaConfirmacaoEmail(caminho, v.USERLoginSite, v.VendNome,
                                    idPV, pv.NomeCliente, emailGrupoEmpresa + ";" + emailRetorno,
                                    corpoEmail, assuntoEmail);
                            else
                                erro = EnviaConfirmacaoEmail(caminho, emailGrupoEmpresa, emailGrupoEmpresa,
                                    idPV, pv.NomeCliente, emailRetorno, corpoEmail, assuntoEmail);

                            #region Erro ao enviar o e-mail

                            Models.HLBAPP.Envio_Confirmacao_Email envio = new Models.HLBAPP.Envio_Confirmacao_Email();
                            envio.IDEnvioConfirmacao = item.IDEnvioConfirmacao;
                            envio.TipoEnvio = tipoAgrupamentoPedidos;

                            int emailSeq = 0;
                            if (!int.TryParse(erro, out emailSeq))
                            {
                                string msg = "Erro ao enviar e-mail por pedido: " + erro;
                    ...
                    else if (tipoAgrupamentoPedidos.Equals("Faturamento"))
                    {
                        #region Envio para Faturamento e Financeiro
                        ...
                        foreach (var empresa in listaEmpresas)
                        {
                            ...
                            string empresaAssuntoEmailFinanceiro = "";
                            string emailFinanceiro = "";
                            string emailProgramacao = "";
                            string anexosEmpresa = "";

                            if (empresa.Key.Equals("BR"))
                            {
                                empresaAssuntoEmailFinanceiro = "HLB";
                                emailFinanceiro = "financeiro@hyline.com.br";
                                emailProgramacao = "programacao@hyline.com.br";
                                if (copiaParaFaturamento == "")
                                    copiaParaFaturamento = "programacao@hyline.com.br";
                                else
                                    copiaParaFaturamento = ";programacao@hyline.com.br";
                            }
                            else if (empresa.Key.Equals("LB"))
                            {
                                empresaAssuntoEmailFinanceiro = "LTZ";
                            ...
                            else if (empresa.Key.Equals("HN"))
                            {
                                empresaAssuntoEmailFinanceiro = "H&N";
                            ...
                            else if (empresa.Key.Equals("PL"))
                            {
                                empresaAssuntoEmailFinanceiro = "PLANALTO";
                            ...
                            foreach (var item in listaItensEmpresa)
                            {
                                #region Gera confirmações e anexa as mesmas de acordo com a Empresa e Local de Nascimento

                                #region Carrega Dados do Pedido

                                Pedido_Venda pv = hlbappService.Pedido_Venda.Where(w => w.ID == item.IDPedidoVenda).FirstOrDefault();
                                var listaPDTP = hlbappService.Prog_Diaria_Transp_Pedidos.Where(w => w.IDPedidoVenda == item.IDPedidoVenda).ToList();
                                Models.Apolo.VENDEDOR v = apoloSession.VENDEDOR.Where(w => w.VendCod == item.Vendedor).FirstOrDefault();
                                string idPV = item.IDPedidoVenda.ToString();
                                ...
                                destino = GeraRelNovaConfirmacao(idPV, pv.NomeCliente, item.TipoPedido, "NovaConfirmacaoFat");
                                ...
                                if (listaPDTP.Where(w => w.LocalNascimento.Equals("NM")).Count() > 0)
                                    if (anexosNM == "")
                                        anexosNM = destino;
                                    else
                                        anexosNM = anexosNM + "^" + destino;
                                ...
                                if (anexosEmpresa == "")
                                    anexosEmpresa = destino;
                                else
                                    anexosEmpresa = anexosEmpresa + "^" + destino;
                            ...
                            #region Envia e-mail das confirmações para o Financeiro

                            string assuntoEmail = empresaAssuntoEmailFinanceiro + " - CONFIRMAÇÕES PARA FATURAMENTO DE " + dataInicial.ToString("dd/MM/yyyy") + " até "
                                + dataFinal.ToString("dd/MM/yyyy");
                            ...
                            erro = EnviaConfirmacaoEmail(anexosEmpresa, emailFinanceiro, "FINANCEIRO " + empresaAssuntoEmailFinanceiro,
                                "", "", emailProgramacao, corpoEmail, assuntoEmail);
                            ...
                            if (!int.TryParse(erro, out emailSeq))
                            {
                                string msg = "Erro ao enviar e-mail para financeiro " + empresa.Key + ": " + erro;
                        ...
                        if (anexosNG != "")
                        {
                            ...
                            erro = EnviaConfirmacaoEmail(anexosNG, "faturamento@hyline.com.br", "FATURAMENTO",
                                "", "", copiaParaFaturamento, corpoEmail, assuntoEmail);
                            ...
                            if (!int.TryParse(erro, out emailSeq))
                            {
                                string msg = "Erro ao enviar e-mail para faturamento HLB: " + erro;
                        ...
                        if (anexosNM != "")
                        {
                            ...
                            erro = EnviaConfirmacaoEmail(anexosNM, "faturamento@planaltopostura.com.br", "FATURAMENTO",
                                "", "", "programacao@planaltopostura.com.br", corpoEmail, assuntoEmail);
                            ...
                            if (!int.TryParse(erro, out emailSeq))
                            {
                                string msg = "Erro ao enviar e-mail para faturamento PPA: " + erro;
            ...
            catch (Exception e)
            {
                ...
                var ec = hlbappSession.Envio_Confirmacao.Where(w => w.ID == idECErro).FirstOrDefault();
                ec.Status = "Erro";
        ...
        public static void IniciaTimer()
        {
            ...
            _oTimerHora = new System.Timers.Timer(300 * 1000); // 5 Minutos
