...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class OrdemProducaoRacao_Adicional: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int IDOrdemProducaoRacao
        {
        ...
        private int _iDOrdemProducaoRacao;
        ...
        [DataMember]
        public decimal QtdKgPorTon
        {
            get { return _qtdKgPorTon; }
            set
            {
                if (_qtdKgPorTon != value)
                {
                    _qtdKgPorTon = value;
                    OnPropertyChanged("QtdKgPorTon");
                }
            }
        }
        private decimal _qtdKgPorTon;
