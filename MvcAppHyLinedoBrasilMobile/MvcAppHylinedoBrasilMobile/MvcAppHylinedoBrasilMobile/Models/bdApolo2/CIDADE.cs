...
namespace MvcAppHylinedoBrasilMobile.Models.bdApolo2
{
    ...
    public partial class CIDADE: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public TrackableCollection<ENDER_ENT> ENDER_ENT
        {
            get
            {
                if (_eNDER_ENT == null)
                {
                    _eNDER_ENT = new TrackableCollection<ENDER_ENT>();
                    _eNDER_ENT.CollectionChanged += FixupENDER_ENT;
                }
                return _eNDER_ENT;
            }
            set
        ...
        private TrackableCollection<ENDER_ENT> _eNDER_ENT;
        ...
        private void FixupUSUARIO(USUARIO previousValue, bool skipKeys = false)
        {
            ...
            if (USUARIO != null)
            {
                if (!USUARIO.CIDADE.Contains(this))
                {
                    USUARIO.CIDADE.Add(this);
                }
        ...
        private void FixupENDER_ENT(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ENDER_ENT item in e.NewItems)
                {
                    item.CIDADE = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ENDER_ENT", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (ENDER_ENT item in e.OldItems)
                {
                    if (ReferenceEquals(item.CIDADE, this))
                    {
                        item.CIDADE = null;
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ENDER_ENT", item);
                    }
                }
            }
        }
