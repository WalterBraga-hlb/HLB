...
namespace MvcAppHylinedoBrasilMobile.Models.bdApolo2
{
    ...
    public partial class DOC_ENTIDADE: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public int DocEntSeq
        {
            get { return _docEntSeq; }
            set
            {
                if (_docEntSeq != value)
                {
                    if (ChangeTracker.ChangeTrackingEnabled && ChangeTracker.State != ObjectState.Added)
                    {
                        throw new InvalidOperationException("The property 'DocEntSeq' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _docEntSeq = value;
                    OnPropertyChanged("DocEntSeq");
                }
            }
        }
        private int _docEntSeq;
    
        [DataMember]
        public string DocEntPathArq
        {
            get { return _docEntPathArq; }
            set
            {
                if (_docEntPathArq != value)
                {
                    _docEntPathArq = value;
                    OnPropertyChanged("DocEntPathArq");
                }
            }
        }
        private string _docEntPathArq;
    
        [DataMember]
        public string DocEntObs
        {
            get { return _docEntObs; }
            set
            {
                if (_docEntObs != value)
                {
                    _docEntObs = value;
                    OnPropertyChanged("DocEntObs");
                }
            }
        }
        private string _docEntObs;
        ...
        [DataMember]
        public Nullable<System.DateTime> DocEntData
        {
            get { return _docEntData; }
            set
            {
                if (_docEntData != value)
                {
                    _docEntData = value;
                    OnPropertyChanged("DocEntData");
                }
            }
        }
        private Nullable<System.DateTime> _docEntData;
        ...
        private void FixupUSUARIO(USUARIO previousValue, bool skipKeys = false)
        {
            ...
            if (previousValue != null && previousValue.DOC_ENTIDADE.Contains(this))
            {
                previousValue.DOC_ENTIDADE.Remove(this);
            }
    
            if (USUARIO != null)
            {
                if (!USUARIO.DOC_ENTIDADE.Contains(this))
                {
                    USUARIO.DOC_ENTIDADE.Add(this);
                }
