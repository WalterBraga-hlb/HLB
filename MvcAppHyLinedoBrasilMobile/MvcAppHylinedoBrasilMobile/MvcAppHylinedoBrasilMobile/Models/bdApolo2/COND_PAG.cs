    ...
    public partial class COND_PAG: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string CondPagUsuCod
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("CondPagUsuCod", _condPagUsuCod);
                    if (!IsDeserializing)
                    {
        ...
        [DataMember]
        public TrackableCollection<COND_PAG_ENT> COND_PAG_ENT
        {
            get
            {
                if (_cOND_PAG_ENT == null)
                {
                    _cOND_PAG_ENT = new TrackableCollection<COND_PAG_ENT>();
                    _cOND_PAG_ENT.CollectionChanged += FixupCOND_PAG_ENT;
                }
                return _cOND_PAG_ENT;
            }
            set
            {
                if (!ReferenceEquals(_cOND_PAG_ENT, value))
                {
                    ...
                    if (_cOND_PAG_ENT != null)
                    {
                        ...
                        foreach (COND_PAG_ENT item in _cOND_PAG_ENT)
                        {
                    ...
                    OnNavigationPropertyChanged("COND_PAG_ENT");
                }
            }
        }
        private TrackableCollection<COND_PAG_ENT> _cOND_PAG_ENT;
        ...
        private void FixupUSUARIO(USUARIO previousValue, bool skipKeys = false)
        {
            ...
            if (USUARIO != null)
            {
                if (!USUARIO.COND_PAG.Contains(this))
                {
                    USUARIO.COND_PAG.Add(this);
                }
    
                CondPagUsuCod = USUARIO.UsuCod;
            }
            else if (!skipKeys)
            {
                CondPagUsuCod = null;
        ...
        private void FixupCOND_PAG_ENT(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (COND_PAG_ENT item in e.NewItems)
                {
                    item.COND_PAG = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("COND_PAG_ENT", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                foreach (COND_PAG_ENT item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("COND_PAG_ENT", item);
