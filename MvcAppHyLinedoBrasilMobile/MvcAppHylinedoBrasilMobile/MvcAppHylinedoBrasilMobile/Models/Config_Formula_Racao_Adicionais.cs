...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class Config_Formula_Racao_Adicionais: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        private void FixupConfig_Formula_Racao(Config_Formula_Racao previousValue)
        {
            ...
            if (previousValue != null && previousValue.Config_Formula_Racao_Adicionais.Contains(this))
            {
                previousValue.Config_Formula_Racao_Adicionais.Remove(this);
            }
    
            if (Config_Formula_Racao != null)
            {
                if (!Config_Formula_Racao.Config_Formula_Racao_Adicionais.Contains(this))
                {
                    Config_Formula_Racao.Config_Formula_Racao_Adicionais.Add(this);
                }
