...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class LINHAGEM_GRUPO: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public string LinhagemCHIC
        {
            get { return _linhagemCHIC; }
            set
            {
                if (_linhagemCHIC != value)
                {
                    _linhagemCHIC = value;
                    OnPropertyChanged("LinhagemCHIC");
                }
            }
        }
        private string _linhagemCHIC;
        ...
        [DataMember]
        public string LinhagemPS
        {
            get { return _linhagemPS; }
            set
            {
                if (_linhagemPS != value)
                {
                    _linhagemPS = value;
                    OnPropertyChanged("LinhagemPS");
                }
            }
        }
        private string _linhagemPS;
