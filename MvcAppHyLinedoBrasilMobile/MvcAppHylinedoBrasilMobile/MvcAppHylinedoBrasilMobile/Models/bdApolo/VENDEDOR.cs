...
namespace MvcAppHylinedoBrasilMobile.Models.bdApolo
{
    ...
    public partial class VENDEDOR: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public string USERSenhaAcessoWeb
        {
            get { return _uSERSenhaAcessoWeb; }
            set
            {
                if (_uSERSenhaAcessoWeb != value)
                {
                    _uSERSenhaAcessoWeb = value;
                    OnPropertyChanged("USERSenhaAcessoWeb");
                }
            }
        }
        private string _uSERSenhaAcessoWeb;
        ...
        [DataMember]
        public TrackableCollection<SUP_VENDEDOR> SUP_VENDEDOR
        {
            get
            {
                if (_sUP_VENDEDOR == null)
                {
                    _sUP_VENDEDOR = new TrackableCollection<SUP_VENDEDOR>();
                    _sUP_VENDEDOR.CollectionChanged += FixupSUP_VENDEDOR;
                }
                return _sUP_VENDEDOR;
            }
            set
            {
                if (!ReferenceEquals(_sUP_VENDEDOR, value))
                {
                    ...
                    if (_sUP_VENDEDOR != null)
                    {
                        ...
                        foreach (SUP_VENDEDOR item in _sUP_VENDEDOR)
                        {
                    ...
                    OnNavigationPropertyChanged("SUP_VENDEDOR");
                }
            }
        }
        private TrackableCollection<SUP_VENDEDOR> _sUP_VENDEDOR;
    
        [DataMember]
        public TrackableCollection<SUP_VENDEDOR> SUP_VENDEDOR1
        {
            get
            {
                if (_sUP_VENDEDOR1 == null)
                {
                    _sUP_VENDEDOR1 = new TrackableCollection<SUP_VENDEDOR>();
                    _sUP_VENDEDOR1.CollectionChanged += FixupSUP_VENDEDOR1;
                }
                return _sUP_VENDEDOR1;
            }
            set
            {
                if (!ReferenceEquals(_sUP_VENDEDOR1, value))
                {
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        throw new InvalidOperationException("Cannot set the FixupChangeTrackingCollection when ChangeTracking is enabled");
                    ...
                    if (_sUP_VENDEDOR1 != null)
                    {
                        ...
                        // This is the principal end in an association that performs cascade deletes.
                        // Remove the cascade delete event handler for any entities in the current collection.
                        foreach (SUP_VENDEDOR item in _sUP_VENDEDOR1)
                        {
                            ChangeTracker.ObjectStateChanging -= item.HandleCascadeDelete;
                        }
                    }
                    _sUP_VENDEDOR1 = value;
                    if (_sUP_VENDEDOR1 != null)
                    {
                        _sUP_VENDEDOR1.CollectionChanged += FixupSUP_VENDEDOR1;
                        // This is the principal end in an association that performs cascade deletes.
                    ...
                    OnNavigationPropertyChanged("SUP_VENDEDOR1");
                }
            }
        }
        private TrackableCollection<SUP_VENDEDOR> _sUP_VENDEDOR1;
        ...
        [DataMember]
        public TrackableCollection<ROTA_ENTREGA> ROTA_ENTREGA
        {
            get
            {
                if (_rOTA_ENTREGA == null)
                {
                    _rOTA_ENTREGA = new TrackableCollection<ROTA_ENTREGA>();
                    _rOTA_ENTREGA.CollectionChanged += FixupROTA_ENTREGA;
                }
                return _rOTA_ENTREGA;
            }
            set
            {
        ...
        private TrackableCollection<ROTA_ENTREGA> _rOTA_ENTREGA;
        ...
        private void FixupSUP_VENDEDOR(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (SUP_VENDEDOR item in e.NewItems)
                {
                    item.VENDEDOR = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("SUP_VENDEDOR", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
            ...
            if (e.OldItems != null)
            {
                foreach (SUP_VENDEDOR item in e.OldItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("SUP_VENDEDOR", item);
        ...
        private void FixupSUP_VENDEDOR1(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (SUP_VENDEDOR item in e.NewItems)
                {
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("SUP_VENDEDOR1", item);
                    }
                    // This is the principal end in an association that performs cascade deletes.
                    // Update the event listener to refer to the new dependent.
                    ChangeTracker.ObjectStateChanging += item.HandleCascadeDelete;
            ...
            if (e.OldItems != null)
            {
                foreach (SUP_VENDEDOR item in e.OldItems)
                {
                    if (ReferenceEquals(item.VENDEDOR1, this))
                    {
                        item.VENDEDOR1 = null;
                    }
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("SUP_VENDEDOR1", item);
                        // Delete the dependent end of this identifying association. If the current state is Added,
                        // allow the relationship to be changed without causing the dependent to be deleted.
                        if (item.ChangeTracker.State != ObjectState.Added)
                        {
        ...
        private void FixupROTA_ENTREGA(object sender, NotifyCollectionChangedEventArgs e)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (e.NewItems != null)
            {
                foreach (ROTA_ENTREGA item in e.NewItems)
                {
                    item.VENDEDOR = this;
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ...
                        ChangeTracker.RecordAdditionToCollectionProperties("ROTA_ENTREGA", item);
                    }
                }
            }
            ...
            if (e.OldItems != null)
            {
                foreach (ROTA_ENTREGA item in e.OldItems)
                {
                    if (ReferenceEquals(item.VENDEDOR, this))
                    {
                        item.VENDEDOR = null;
                    ...
                    if (ChangeTracker.ChangeTrackingEnabled)
                    {
                        ChangeTracker.RecordRemovalFromCollectionProperties("ROTA_ENTREGA", item);
                    }
                }
            }
        }
