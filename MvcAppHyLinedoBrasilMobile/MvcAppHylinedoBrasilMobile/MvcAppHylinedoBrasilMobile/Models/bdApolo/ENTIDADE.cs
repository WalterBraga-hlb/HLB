    ...
    public partial class ENTIDADE: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string StatEntCod
        {
            ...
            set
            {
                ...
                {
                    ChangeTracker.RecordOriginalValue("StatEntCod", _statEntCod);
                    if (!IsDeserializing)
                    {
                        if (STAT_ENT != null && STAT_ENT.StatEntCod != value)
                        {
                            STAT_ENT = null;
                        }
                    }
        ...
        [DataMember]
        public STAT_ENT STAT_ENT
        {
            get { return _sTAT_ENT; }
            set
            {
                if (!ReferenceEquals(_sTAT_ENT, value))
                {
                    var previousValue = _sTAT_ENT;
                    _sTAT_ENT = value;
                    FixupSTAT_ENT(previousValue);
                    OnNavigationPropertyChanged("STAT_ENT");
                }
            }
        }
        private STAT_ENT _sTAT_ENT;
        ...
        private void FixupSTAT_ENT(STAT_ENT previousValue, bool skipKeys = false)
        {
            if (IsDeserializing)
            {
                return;
            ...
            if (STAT_ENT != null)
            {
                if (!STAT_ENT.ENTIDADE.Contains(this))
                {
                    STAT_ENT.ENTIDADE.Add(this);
                }
    
                StatEntCod = STAT_ENT.StatEntCod;
            }
            else if (!skipKeys)
            {
                StatEntCod = null;
            ...
            if (ChangeTracker.ChangeTrackingEnabled)
            {
                if (ChangeTracker.OriginalValues.ContainsKey("STAT_ENT")
                    && (ChangeTracker.OriginalValues["STAT_ENT"] == STAT_ENT))
                {
                    ChangeTracker.OriginalValues.Remove("STAT_ENT");
                }
                else
                {
                    ChangeTracker.RecordOriginalValue("STAT_ENT", previousValue);
                }
                if (STAT_ENT != null && !STAT_ENT.ChangeTracker.ChangeTrackingEnabled)
                {
                    STAT_ENT.StartTracking();
                }
            }
        }
