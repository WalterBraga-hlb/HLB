...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class Config_Formula_Racao_Unidade: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public string CodUnidade
        {
            ...
            set
            {
                if (_codUnidade != value)
                {
                    _codUnidade = value;
                    OnPropertyChanged("CodUnidade");
                }
            }
        }
        private string _codUnidade;
        ...
        private void FixupConfig_Formula_Racao(Config_Formula_Racao previousValue)
        {
            ...
            if (previousValue != null && previousValue.Config_Formula_Racao_Unidade.Contains(this))
            {
                previousValue.Config_Formula_Racao_Unidade.Remove(this);
            }
    
            if (Config_Formula_Racao != null)
            {
                if (!Config_Formula_Racao.Config_Formula_Racao_Unidade.Contains(this))
                {
                    Config_Formula_Racao.Config_Formula_Racao_Unidade.Add(this);
                }
