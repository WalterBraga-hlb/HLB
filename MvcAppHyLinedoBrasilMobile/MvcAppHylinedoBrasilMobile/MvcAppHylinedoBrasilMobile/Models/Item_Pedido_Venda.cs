...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class Item_Pedido_Venda: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        public Nullable<int> Alterado
        {
            ...
            set
            {
                ...
                {
                    _alterado = value;
                    OnPropertyChanged("Alterado");
                }
            }
        }
        private Nullable<int> _alterado;
    
        [DataMember]
        public Nullable<int> Importar
        {
            ...
            set
            {
                ...
                {
                    _importar = value;
                    OnPropertyChanged("Importar");
                }
            }
        }
        private Nullable<int> _importar;
