...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class LOG_Servicos_Pedido_Venda: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        [DataMember]
        public Nullable<int> IDServPedVenda
        {
            get { return _iDServPedVenda; }
            set
            {
                if (_iDServPedVenda != value)
                {
                    _iDServPedVenda = value;
                    OnPropertyChanged("IDServPedVenda");
                }
            }
        }
        private Nullable<int> _iDServPedVenda;
