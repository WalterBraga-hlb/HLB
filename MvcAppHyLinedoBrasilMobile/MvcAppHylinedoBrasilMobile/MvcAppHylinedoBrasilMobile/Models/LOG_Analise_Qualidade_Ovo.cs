...
namespace MvcAppHylinedoBrasilMobile.Models
{
    ...
    public partial class LOG_Analise_Qualidade_Ovo: IObjectWithChangeTracker, INotifyPropertyChanged
    {
        ...
        {
            get { return _naoConformidade; }
            set
            {
                if (_naoConformidade != value)
                {
                    _naoConformidade = value;
                    OnPropertyChanged("NaoConformidade");
                }
            }
        }
        private string _naoConformidade;
